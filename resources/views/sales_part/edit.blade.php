								...
								<table class="table table-bordered adddatatable" id="tab_taxes_detail" align="center" style="font-size:14px;" width="100%">
									...
									@foreach($stock as $stocks)
										<tr id="row_id_<?php echo $row_id;?>">
											...
											<td>
												<input type="text" name="product[qty][]" url="{!! url('purchase/add/getqty')!!}" class="quantity form-control qty qty_<?php echo $row_id;?>" id="qty_<?php echo $row_id;?>" row_id="<?php echo $row_id;?>" value="{{$stocks->quantity}}" maxlength="8" style="width: 50%;">
											...
											<td>
												<input type="text" name="product[total_price][]" class="product form-control total_price total_price_<?php echo $row_id;?>"  value="{{$stocks->total_price}}"  id="total_price_<?php echo $row_id;?>" style="width:100%;" readonly="true">
											</td>
											<td align="center">
