            ...
            <div class="x_content">
               <form method="post" action="update/{{ $user->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
				...
				<div class="col-md-12 col-sm-6 col-xs-12">  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('firstname') ? ' has-error' : '' }}">
                     <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">{{ trans('app.First Name')}}
                     </label>
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="firstname" name="firstname" class="form-control" value="{{ $user->name }}"  placeholder="{{ trans('app.Enter First Name')}}" maxlength="25">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('lastname') ? ' has-error' : '' }}">
                     <label class="control-label col-md-4 col-sm-4 col-xs-12" for="last-name">{{ trans('app.Last Name')}} 
                     </label>
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="lastname" name="lastname" class="form-control" value="{{ $user->lastname }}" placeholder="{{ trans('app.Enter Last Name')}}" maxlength="25">
				...
				<div class="col-md-12 col-sm-6 col-xs-12">  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                     <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">{{ trans('app.Company Name')}}</label>
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="displayname" class="form-control"  name="displayname" value="{{ $user->display_name }}" placeholder="{{ trans('app.Enter Display Name')}}" maxlength="50">
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
				...
				<div class="col-md-12 col-sm-6 col-xs-12">  
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                     ...
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="email" name="email" class="form-control" value="{{ $user->email }}" placeholder="{{ trans('app.Enter Email')}}"  maxlength="50" required>
                        @if ($errors->has('email'))
                        <span class="help-block">
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('mobile') ? ' has-error' : '' }}">
                     ...
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="mobile" name="mobile" class="form-control" value="{{ $user->mobile_no }}" maxlength="15" placeholder="{{ trans('app.Enter Mobile No')}}" required>
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('contact_person') ? ' has-error' : '' }}">
                     <label class="control-label col-md-4 col-sm-4 col-xs-12">{{ trans('app.Contact Person')}} 
                     </label>
                     <div class="col-md-8 col-sm-8 col-xs-12">
				...
				<div class="col-md-12 col-sm-6 col-xs-12">  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('landlineno') ? ' has-error' : '' }}">
                     <label class="control-label col-md-4 col-sm-4 col-xs-12" for="landline-no">{{ trans('app.Landline No')}} 
                     </label>
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="landlineno" name="landlineno" class="form-control" value="{{ $user->landline_no }}" maxlength="15" placeholder="{{ trans('app.Enter LandLine No')}}">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                     ...
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        @endif
                        <img src="{{ URL::asset('public/supplier/'.$user->image) }}"  width="40px" height="40px" class="img-circle" style="margin-top:10px;">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                     ...
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        <textarea  id="address" name="address" maxlength="100" class="form-control" required>{{ $user->address }}</textarea>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                     ...
                     <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        @else
                        <input type="{{$tbl_custom_field->type}}" name="custom[{{$tbl_custom_field->id}}]"  class="form-control" placeholder="Enter {{$tbl_custom_field->label}}" maxlength="30" value="{{$datavalue}}"{{$required}}>
                        @endif
                     </div>
                  </div>
                  @endforeach	
