        ...
        <div class="">
			...
			<div class="x_content">
                <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
					...
					<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('/rto/add')!!}"><span class="visible-xs"></span> <i class="fa fa-plus-circle fa-lg">&nbsp;</i><b>{{ trans('app.Add RTO Taxes')}}</b></span></a></li>
				</ul>
			</div>
            <div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_content">
							<form method="post" action="{!! url('rto/store') !!}" enctype="multipart/form-data"  class="form-horizontal upperform">
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback {{ $errors->has('rto_tax') ? ' has-error' : '' }}">
									...
									<div class="col-md-5 col-sm-5 col-xs-12">
										<input type="text" id="rto_tax" name="rto_tax"  class="form-control" maxlength="10" value="{{ old('rto_tax')}}" placeholder="{{ trans('app.Enter RTO Registration Tax')}} " required/>
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback {{ $errors->has('num_plate_tax') ? ' has-error' : '' }}">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="num_plate_tax">{{ trans('app.Number Plate charge')}} <label class="text-danger">*</label></label>
									<div class="col-md-5 col-sm-5 col-xs-12">
										<input type="text" id="num_plate_tax" name="num_plate_tax"  class="form-control" placeholder="{{ trans('app.Enter number plate charge')}}" value="{{ old('num_plate_tax')}}" maxlength="10" required>
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback {{ $errors->has('mun_tax') ? ' has-error' : '' }}">
									...
									<div class="col-md-5 col-sm-5 col-xs-12">
										<input type="text" id="mun_tax" name="mun_tax"  class="form-control" placeholder="{{ trans('app.Eneter Municipal Road Tax')}}" value="{{ old('mun_tax')}}" maxlength="10" required>
