	...
	<div class="right_col" role="main">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						<form  action="{{ url('/vehicle/store') }}" method="post" enctype="multipart/form-data"  class="form-horizontal upperform">
							...
							<div class="form-group" style="margin-top:20px;">
								...
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="chasicno"  value="{{ old('chasicno') }}" placeholder="{{ trans('app.Enter ChasicNo')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="gearno"  value="{{ old('gearno') }}" placeholder="{{ trans('app.Enter No of Gear')}}" maxlength="5" class="form-control" required>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="{{ $errors->has('price') ? ' has-error' : '' }}">
									...
									{{ trans('app.Price' )}} (<?php echo getCurrencySymbols(); ?>) <label class="text-danger">*</label></label>
									<div class="col-md-4 col-sm-4 col-xs-12">
							...
							<div class="form-group">
								<div class="{{ $errors->has('odometerreading') ? ' has-error' : '' }}">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="odometerreading"  value="{{ old('odometerreading') }}" placeholder="{{ trans('app.Enter Odometer Reading')}}" maxlength="20"  class="form-control" required>
									</div>
								</div>
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12 input-group date datepicker">
										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
										<input type="text"  name="dom" class="form-control" placeholder="<?php echo getDatepicker();?>" onkeypress="return false;" required />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="gearbox"  value="{{ old('gearbox') }}" placeholder="{{ trans('app.Enter Grear Box')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
								<div class="">
							...
							<div class="form-group">
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="engineno"  value="{{ old('engineno') }}" placeholder="{{ trans('app.Enter Engine No')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="enginesize"  value="{{ old('enginesize') }}" placeholder="{{ trans('app.Enter Engine Size')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="keyno"  value="{{ old('keyno') }}" placeholder="{{ trans('app.Enter Key No')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
								<div class="">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<input type="text"  name="engine"  value="{{ old('engine') }}" placeholder="{{ trans('app.Enter Engine')}}" maxlength="30" class="form-control" required>
									</div>
								</div>
							</div>
