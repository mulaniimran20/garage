<tr id="row_id_<?php echo $ids;?>">
	...
	<td>
		<select class="form-control select_producttype" name="product[Manufacturer_id][]" m_url="{!! url('/purchase/producttype/name') !!}" row_did="<?php echo $ids;?>" data-id="<?php echo $ids;?>" style="width:100%;" required>
