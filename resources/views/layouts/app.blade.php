...
<head>
	...
	<link rel="icon" href="{{ URL::asset('favicon.png') }}" type="image/gif" sizes="32x32">
    <title>AARFAA TECHNOVISION - Garage Management System</title>
...
<body id="app-layout" class="nav-md">
   <div class="container body">
    <div class="main_container">
       <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title hidden-xs" style="border: 0; ">
			  ...
			  <img src="{{ URL::asset('public/general_setting/aarfaa_logo_garage.png')}}"
			   class="profilepic" ></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<li><a href="{!! url('/sales_part/list') !!}"><i class="fa fa-tty image_icon"></i>{{ trans('app.Sale Part')}} </a> </li>
				@endif

				<?php $userid=Auth::User()->id;?>
				@if (getAccessStatusUser('Compliance',$userid)=='yes')
				  <li><a href="{!! url('/rto/list') !!}"><i class="fa fa-clone"></i>{{ trans('app.Compliance')}}</a>
                  </li>
				@endif
	   ...
	   <footer>
          <div>
             <span class="footerbottom">{{ trans('app.All rights reserved by AARFAA TECHNOVISION Pvt Ltd.')}}</span>
          </div>
