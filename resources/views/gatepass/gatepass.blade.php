					...
					<div class="x_content">
						...
						enctype="multipart/form-data" data-parsley-validate 
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('jobcard') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="jobcard">{{ trans('app.JobCard No. ') }} <label class="text-danger">*</label>	</label>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('firstname') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="firstname">{{ trans('app.First Name') }} <label class="text-danger">*</label></label>
								<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('lastname') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="lastname">{{ trans('app.Last Name') }} <label class="text-danger">*</label></label>
								<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('model_name') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="model_name">{{ trans('app.Vehicle Name') }} <label class="text-danger" >*</label></label>
								<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('chassis') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="chassis">{{ trans('app.Chassis') }} <label class="text-danger" >*</label></label>
								<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('kms') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kms">{{ trans('app.KMs.Run') }} <label class="text-danger" >*</label></label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" id="kms" name="kms" placeholder="{{ trans('app.Enter Kms. Run')}}" class="form-control jobcard" readonly >
								</div>
							</div>
							<div class="col-md-12 col-xs-12 col-sm-12 space">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group {{ $errors->has('out_date') ? ' has-error' : '' }}">
								<label class="control-label col-md-3 col-sm-3 col-xs-12 currency" for="servie_out_date">{{ trans('app.Vehicle Out Date') }} <label class="text-danger" >*</label></label>
								...
								<div class="col-md-9 col-sm-9 col-xs-12 input-group date datepicker">
									...
									<input type="text"  id="" name="out_date" placeholder="YYYY-MM:DD hh:mm:ss" class="form-control" onkeypress="return false;" required >
								</div>
