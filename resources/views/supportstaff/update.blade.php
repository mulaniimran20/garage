	...
	@else
        <div class="right_col" role="main">
          <div class="">
			...
			<li role="presentation" class="active suppo_llng_li_add floattab"><a href="{!! url('/supportstaff/list/edit/'.$supportstaff->id)!!}"><span class="visible-xs"></span><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp;</i> <b>{{ trans('app.Edit Supportstaff')}}</b></a></li>
