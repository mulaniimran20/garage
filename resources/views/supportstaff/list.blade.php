              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_content">
                   <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
						<li role="presentation" class="active suppo_llng_li floattab"><a href="{!! url('/supportstaff/list')!!}"><span class="visible-xs"></span><i class="fa fa-list fa-lg">&nbsp;</i><b>{{ trans('app.Supportstaff List') }}</b></a></li>
					@if(!empty(getActiveCustomer($userid)=='yes'))
						<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/supportstaff/add')!!}"><span class="visible-xs"></span><i class="fa fa-plus-circle fa-lg">&nbsp;</i> {{ trans('app.Add Supportstaff') }}</a></li>
					@endif
            </ul>
			</div>
					  ...
					  <?php $i=1;?>
					   @foreach($supportstaff as $supportstaffs)
                        <tr>
                          ...
                          <td>{{ $i }}</td>
                          <td><img src="{{ url('public/supportstaff/'.$supportstaffs->image) }}"  width="50px" height="50px" class="img-circle" ></td>
                          ...
                          <td> 
							@if(!empty(getActiveCustomer($userid)=='yes'))
								<a href="{!! url('/supportstaff/list/'.$supportstaffs->id) !!}">
