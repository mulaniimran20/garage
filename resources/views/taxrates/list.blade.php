            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
						<li role="presentation" class="active suppo_llng_li floattab"><a href="{!! url('/taxrates/list')!!}"><span class="visible-xs"></span> <i class="fa fa-list fa-lg">&nbsp;</i> <b>{{ trans('app.List Account Tax')}}</b></a></li>
						<li role="presentation" class="suppo_llng_li_add floattab"><a href="{!! url('/taxrates/add')!!}"><span class="visible-xs"></span> <i class="fa fa-plus-circle fa-lg">&nbsp;</i>{{ trans('app.Add Account Tax')}}</a></li>
